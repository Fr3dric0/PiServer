...
function deleteVideo(vidID, callback) {
    findVideoByID(vidID, function (err, vid) {
        if (err) {
        }
        if (vid == null || vid == {}) {
...
function getPathToVidFolder(vidID, video) {
    var path = "";
    var type = "";
    switch (video.type) {
        case "tv-show":
...
function findVideoByID(vidID, callback) {
    request({
        uri: api_url + "/" + vidID,
        method: "GET",
        headers: {
...
//# sourceMappingURL=VideoFileHandler.js.map